...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
		    ...
		    <?php
			 $tg_blog_display_tags = get_theme_mod('tg_blog_display_tags', 0);
		   ...
		   <hr/>
			...
			<?php
			    $tg_blog_display_author = get_theme_mod('tg_blog_display_author', 1);
			...
			<?php
			    $tg_blog_display_related = get_theme_mod('tg_blog_display_related', 1);
			...
			if ($tags) {
			 ...
			 ?>
			 	<hr/><br class="clear"/><br/>
			  	<h6 class="subtitle"><span><?php echo esc_html_e('You might also like', 'photography' ); ?></span></h6>
